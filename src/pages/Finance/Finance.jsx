...
const Finance = () => {
  ...
  const handleExportAll = () => {
    // Export both donations and expenses
    handleExportFinancialData('donations');
    setTimeout(() => {
      handleExportFinancialData('expenses');
    }, 1000);
    alert('All financial data has been exported successfully!');
  };
        ...
        <div className="space-y-6">
          <Card>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button variant="outline" icon={FiDownload} size="sm" onClick={handleExportAll}>Export All</Button>
            </div>
